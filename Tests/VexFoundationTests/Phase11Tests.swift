...
struct Phase11Tests {
    ...
    private func makeFormattedNote(keys: [StaffKeySpec] = [StaffKeySpec(letter: .c, octave: 4)], duration: NoteValue = .quarter) -> StaveNote {
    ...
    @Test func graceNoteCreation() {
        let gn = GraceNote(GraceNoteStruct(keys: [StaffKeySpec(letter: .c, octave: 4)], duration: .eighth))
    ...
    @Test func graceNoteWithSlash() {
        let gn = GraceNote(GraceNoteStruct(keys: [StaffKeySpec(letter: .d, octave: 4)], duration: .eighth, slash: true))
    ...
    @Test func graceNoteDefaultDuration() {
        let gn = GraceNote(GraceNoteStruct(keys: [StaffKeySpec(letter: .c, octave: 4)]))
    ...
    @Test func graceNoteGroupCreation() {
        let gn1 = GraceNote(GraceNoteStruct(keys: [StaffKeySpec(letter: .c, octave: 4)], duration: .eighth))
        let gn2 = GraceNote(GraceNoteStruct(keys: [StaffKeySpec(letter: .d, octave: 4)], duration: .eighth))
    ...
    @Test func staveLineNotesCustomIndices() {
        let note1 = makeFormattedNote(keys: [StaffKeySpec(letter: .c, octave: 4), StaffKeySpec(letter: .e, octave: 4)])
        let note2 = makeFormattedNote(keys: [StaffKeySpec(letter: .d, octave: 4), StaffKeySpec(letter: .f, octave: 4)])
